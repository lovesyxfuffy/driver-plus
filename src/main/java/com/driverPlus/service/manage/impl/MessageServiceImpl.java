...
public class MessageServiceImpl implements MessageService{
    ...
    @Override
    public boolean noticeMessage(String telephone,String content,String smsTemplateCode)throws Exception{
...
//替换成你的AK
        final String accessKeyId = "LTAIf6eqdcf7skZo";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "3bN8ZUcZ9c4ps4ChOFrKKDsVaEOyop";//你的accessKeySecret，参考本文档步骤2
//初始化ascClient,暂时不支持多region
        ...
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode(smsTemplateCode);//"SMS_73090055"
